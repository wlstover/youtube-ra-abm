    ...
    for treatment in ['no_recommend', 'high_value', 'random']:
        ...
        for i in range(1,101):
           ...
           # optimal_search_value = model.calculateOptimalSearchValue(model.video_boxes)
            ...
            agent_payoff_treatment_df = pd.DataFrame(agent_payoffs, columns=['final_payoff', 'uid', 'patience', 'step_number', 'acuity', 'recommender_trust', 'recommender_hv', 'recommender_random', 'watcher_type', 'search_quality'])
